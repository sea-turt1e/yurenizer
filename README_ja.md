...
### **3. unify_level（統一レベル）**
**どのレベルまで統一するか**を`unify_level`で指定します。

| **値**          | **説明**                                                                                                                                                            |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `lexeme`       | 最も広範な統一を行います。後述4の **a, b, cグループ全て** を統一対象とします。                                                                                     |
| `word_form`    | 語形単位での統一を行います。後述4の **b, cグループ** を統一対象とします。                                                                                          |
| `abbreviation` | 略語単位での統一を行います。後述4の **cグループ** のみを統一対象とします。                                                                                          |
...
### カスタム辞書のフォーマット
カスタム辞書を使う場合には以下のようなフォーマットのjson, csv, tsvファイルのどれかを作成してください。  
- JSONファイルの場合
```json
{
    "代表語1": ["同義語1_1", "同義語1_2", ...], 
